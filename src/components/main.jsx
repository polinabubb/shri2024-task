    ...
    return (
        <main className="main">
            <section className="section main__general">
                ...
                <div className="hero-dashboard" rel="preload">
            ...
            <section className="section main__devices">
                <div className="section__title">
                    ...
                    <label>
                        <select className="section__select" defaultValue="all" onInput={onSelectInput} rel="preload"
                        >
                            {TABS_KEYS.map(key =>
                ...
                <div className="section__panel-wrapper" ref={ref}>
                    ...
                    {hasRightScroll &&
                        <div className="section__arrow" onClick={onArrowCLick} rel="preload"></div>
                    }
                </div>
            </section>
        </main>
