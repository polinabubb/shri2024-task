...
export function Header() {
    ...
    return <header className="header">
        <a href="/" className="header__logo" aria-label="Яндекс.Дом" rel="preload" as="image" loading="lazy"></a>
        <button className="header__menu" aria-expanded={expanded ? 'true' : 'false'} onClick={onClick} rel="preload" as="image" loading="lazy">
