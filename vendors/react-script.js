...
function Event(props) {
    ...
    return (<li ref={ref} className={'event' + (props.slim ? ' event_slim' : '')}>
        <button className="event__button">
            <span rel="preload" className={`event__icon event__icon_${props.icon}`} role="img" aria-label={props.iconLabel}></span>
    ...
    return <main className="main">
        ...
        <section className="section main__devices">
            ...
            <div className="section__panel-wrapper" ref={ref}>
                ...
                {hasRightScroll &&
                    <div className="section__arrow" onClick={onArrowCLick} rel="preload" as="image" loading="lazy"></div>
                }
            </div>
        </section>
    </main>;
